...
int board[20][20];
void evaluate() ;
void many( int bef[20][20], int check[20][20][8][2]);
void val(int check[20][20][8][2], int a1[20][20],int a2[20][20] )  ;
	...
	while(1){      
		...
		switch (cmd){
			...
			case 1: 
			 ...
			 printf("********************board\n");  	
           	int i,j;	for (i=0;i<20;i++) {for (j=0;j<20;j++) printf("%d  ",board[i][j]);	printf("\n");}    
           printf("********************\n")  ;
        	    fflush(stdout);
            	break;
...
void evaluate()  
{	
	int bef[20][20],aft[20][20];//opp:1 my:2
  ...
  int dy[8] = {-1, -1, 0, 1, 1, 1, 0, -1}; 
	...
	for (i = 0;i <= 19;i++)
	   ...
	   printf("********************bef\n");            		for (i=0;i<20;i++) {for (j=0;j<20;j++) printf("%d  ",bef[i][j]);	printf("\n");}    
