...
extern bool paused,finished,disableScore,isWin9X,isClient,isServer,isNetGame,isListening,turTimerAvail,levelChanged,cmdLineGame;
...
extern char *title;
extern TfileName fnstate,TahDat,PlochaDat,TimeOutsDat,MsgDat,InfoDat;
